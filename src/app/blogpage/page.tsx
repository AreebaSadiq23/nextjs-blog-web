...
const blogPosts = [
  ...
  { id: '4', title: 'Optimizing React Performance', content: 'Learn techniques to improve the performance of your React applications.', category: 'React', imageUrl: '/images/rea.png', date: 'Dec 27, 2024' },
  { id: '5', title: 'Introduction to Python', content: 'Python is a beginner-friendly, versatile programming language ideal for web development, data analysis, AI, and more.', category: 'Python', imageUrl: '/images/python.png', date: 'Dec 28, 2024' },
  { id: '6', title: 'Responsive Design Best Practices', content: 'Master the art of creating websites that look great on any device.', category: 'Web Design', imageUrl: '/images/web.jpg', date: 'Dec 29, 2024' },
];
...
const Blog = () => {
  return (
    <Layout>
      {/* Banner Section */}
      <div className="relative w-full h-[400px] bg-cover bg-center" style={{ backgroundImage: 'url(/images/blog.jpeg)' }}>
